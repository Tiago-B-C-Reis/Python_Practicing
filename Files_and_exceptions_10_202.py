...
files_names = ['text_files/alice.txt', 'text_files/siddhartha.txt', 'text_files/moby_dick.txt',
...
# 10.8
files_name = ["text_files/Cats.txt", "text_files/dogs.txt"]
...
# 10.10
file_names = "text_files/10_10.txt"
